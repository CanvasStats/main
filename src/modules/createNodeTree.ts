                ...
                listItems.push([
                    {
                        ...
                        onClick: () => {
                            navigateTo("/users/user", { params: { name: item.contentKey, year: year } });
                        }
                    },
                    {
                        elem: 'span',
    ...
    return [
        ...
        [
            ...
            [
                ...
                block.icon ? [{ elem: 'span', attr: 'class', attrVal: 'material-symbols-outlined icon', txtNode: block.icon.trim() }] : null,
                { elem: 'section' },
                sectionChildren
            ].filter(Boolean)
        ]
